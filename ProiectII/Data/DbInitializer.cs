        ...
        private static async Task SeedFoxesAndReportsAsync(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            ...
            if (!context.Foxes.Any())
            {
                ...
                context.Foxes.AddRange(
                    new Fox { Name = "Foxy", Description = "Friendly and fast.", ImageUrl = "/uploads/foxes/foxy.jpg", StatusId = healthy.Id, EnclosureId = alphaWing.Id, FirstSeenLocationId = locForest.Id },
                    new Fox { Name = "Shadow", Description = "Hard to spot.", ImageUrl = "/uploads/foxes/shadow.jpg", StatusId = treatment.Id, EnclosureId = alphaWing.Id },
                    new Fox { Name = "Rusty", Description = "Found near the road.", ImageUrl = "/uploads/foxes/rusty.jpg", StatusId = quarantined.Id, EnclosureId = betaWing.Id, FirstSeenLocationId = locHighway.Id },
                    new Fox { Name = "Luna", Description = "Very playful.", ImageUrl = "/uploads/foxes/luna.jpg", StatusId = healthy.Id, EnclosureId = alphaWing.Id }
                );
                await context.SaveChangesAsync();
            }
